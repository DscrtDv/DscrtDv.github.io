...
function Intro() {
    return (
        ...
        min-h-screen max-w-full overflow-hidden p-6'>
            <h1 className='floating self-start text-5xl lg:text-8xl md:text-7xl mb-1 md:mb-3 font-bold pb-10'>Tim Censier</h1>
            ...
            <p className='font-open place-self-end text-base max-w-4xl mb-6 font-bold text-left lg:text-xl'>
                If there is one thing I can say about myself, is that I am a generalist. Starting at software engineering,
